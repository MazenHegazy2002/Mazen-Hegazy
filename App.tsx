...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!sessionStorage.getItem('v4.23_alerted')) {
      alert("⚠️ VERSION 4.23 - DASHBOARD MODE ⚠️\n\n- ADDED PERSISTENT STATUS BOX\n- CLEANED UP TRANSCEIVERS\n- CHECK TOP LEFT FOR STATS\n\nPlease screenshot the DEBUG DASHBOARD.");
      sessionStorage.setItem('v4.23_alerted', 'true');
    }
  }, []);
