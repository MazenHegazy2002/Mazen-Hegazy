...
// MEGA CONFIGURATION - RESTORING RELAYS
// We need TURN servers (Relays) because STUN is failing to find a path.
const configuration = {
  iceServers: [
    // Google STUN (reliable for simple NAT)
    { urls: 'stun:stun.l.google.com:19302' },
    { urls: 'stun:stun1.l.google.com:19302' },
    { urls: 'stun:stun2.l.google.com:19302' },
    // OpenRelay (Free TURN - CRITICAL for bypassing Firewalls)
    {
